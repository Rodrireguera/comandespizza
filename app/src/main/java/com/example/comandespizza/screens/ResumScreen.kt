...
@Composable
fun ResumScreen (navController: NavController, viewModel: PizzaViewModel){

    var comandaConfirmada by remember { mutableStateOf(false) }
    ...
    Column {
        ...
        Button(
            onClick = { comandaConfirmada = true }
        ) {
            Text("Confirmar")
        }
